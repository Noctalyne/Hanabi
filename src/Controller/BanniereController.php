...
class BanniereController extends AbstractController
{
    ...
    {
        return $this->render('/pages/Administration/banniere/list_ban.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager, SluggerInterface $slugger): Response
    {
        ...
        return $this->render('/pages/Administration/banniere/gestion/add_new_carousel.html.twig', [
            'banniere' => $banniere,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('/pages/Administration/banniere/show_banner.html.twig', [
            'banniere' => $banniere,
        ]);
    }
    ...
    public function edit(Request $request, Banniere $banniere, EntityManagerInterface $entityManager, BanniereRepository $banniereRepository, SluggerInterface $slugger): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->render('/pages/Administration/banniere/gestion/_edit_banner.html.twig', [
                'banniere' => $banniere,
                'form' => $form,
